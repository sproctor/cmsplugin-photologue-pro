...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Album'
        db.create_table(u'cmsplugin_album', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('album', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photologue.Gallery'])),
            ('per_page', self.gf('django.db.models.fields.IntegerField')(default=100, max_length=3)),
        ))
        db.send_create_signal(u'cmsplugin_photologue_pro', ['Album'])


    def backwards(self, orm):
        # Deleting model 'Album'
        db.delete_table(u'cmsplugin_album')
